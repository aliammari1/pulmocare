...
class ProfileRadioView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Consumer<AuthRadioViewModel>(
            ...
            TextButton(
              onPressed: () async {
                if (formKey.currentState!.validate()) {
                  try {
                    await context.read<AuthRadioViewModel>().changePassword(
                          currentPasswordController.text.trim(),
                          newPasswordController.text.trim(),
                        );

                    final error =
                        context.read<AuthRadioViewModel>().errorMessage;
                    if (error.isEmpty) {
                      Navigator.pop(ctx);
  ...
  void _showEditProfileDialog(BuildContext context) async {
    final authVM = context.read<AuthRadioViewModel>();
