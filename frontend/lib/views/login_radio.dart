...
class LoginRadioView extends StatefulWidget {
  ...
  @override
  _LoginRadioViewState createState() => _LoginRadioViewState();
}

class _LoginRadioViewState extends State<LoginRadioView> {
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => SignupRadioView()),
                          ),
                          child: RichText(
                            text: TextSpan(
