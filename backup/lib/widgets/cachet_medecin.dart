...
class CachetMedecin extends StatelessWidget {
  ...
  Future<void> _pickImage(BuildContext context) async {
    try {
      ...
      print('Démarrage de la sélection d\'image...');
      ...
      Uint8List? bytes;
      try {
        // Lecture directe des bytes pour le web et mobile
        bytes = await pickedFile.readAsBytes();
        print('Lecture des bytes réussie - Taille: ${bytes.length}');
        ...
        print('Image valide, application du cachet...');
        onSelect(bytes);
      } catch (readError) {
        print('Erreur lors de la lecture du fichier: $readError');
        throw Exception('Impossible de lire le fichier: $readError');
      }
    } catch (e, stackTrace) {
